...
This API can make a normal conversion with currency to currency and it can convert an amount of that currency to the distined one. It also covers every case including edge cases and it tells exactly what is wrong. The input of every call is consisted of base currency, targeted currency, and amount. If you did not pass an amount to be converted it is set to default of 1 but the other attributes is required in order to get an output.<br>
I have made the cache as stated for a bonus.<br>
